...
const FoodCart = ({ id, name, price, desc, rating, img }) => {
    return (
        <div key={id} className='w-full md:w-[calc(50%-20px)] lg:w-[250px] bg-white p-4 flex flex-col rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300'>
            ...
            <button className='mt-4 p-2 text-white bg-green-500 hover:bg-green-600 rounded-lg text-sm'>
                Add to Cart
            </button>
        </div>
    )
